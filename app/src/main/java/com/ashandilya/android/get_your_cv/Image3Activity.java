...
public class Image3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        imageView = findViewById(R.id.combination);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case android.R.id.home:
                Intent intent = new Intent(Image3Activity.this,ListviewActivity.class);
                startActivity(intent);
            case R.id.samplecv:
                Intent intent1 = new Intent(Image3Activity.this,ListviewActivity.class);
                startActivity(intent1);
                break;
            case R.id.abc:
                Intent intent2 = new Intent(Image3Activity.this,DrawerActivity.class);
